  ...
  <layout ref="layout">
    <div class="slot_body" slot="component-view">
      <div class="content" style="display: block">
        <div class="card">
          <headerClose :title="'GESTIÓN DE PROVEEDORES'"></headerClose>
          ...
          <div class="card-body card-block">
            <div class="text-center">
              ...
              >
                ...
                <span class="text font-size-layout">Nuevo Proveedor</span>
              </button>
            </div>
            <br />
            ...
            <table class="table table-hover" id="tblProveedores">
              <thead>
                <tr>
                  ...
                  <th>DNI / RUC</th>
                  <th>NOMBRE_EMPRESA / RAZÓN_SOCIAL</th>
  ...
  methods: {
    AñadirResponsive() {
      if (this.windowWidth < 1534) {
        if (!$("#tblProveedores").hasClass("table-responsive")) {
          document
    ...
    EliminarProveedor(proveedor) {
      ...
      Swal.fire({
          ...
          preConfirm: () => {
            ...
            data.append("id", self.form_datos_usuario.id);
            self.$inertia.post(
