          ...
          <div class="card-body card-block">
            <div class="text-center">
              ...
              >
                ...
                <span class="text font-size-layout">Nuevo Usuario</span>
              </button>
            </div>
            <br />
                  ...
                  >
                    ...
                    <div class="form-row">
                      <div class="form-group col-sm-4">
                        <span
                          v-if="
                            submited && !$v.form_datos_usuario.genero.noZero
                          "
                          class="span-error-message"
                        >
                          *
                        ...
                        <select
                          class="form-control center"
                          style="max-width: 200px"
                          v-model="form_datos_usuario.genero"
                        >
                  ...
                  >
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-sm-8">
                        <span
                          v-if="
                            submited && !$v.form_datos_usuario.correo.required
                          "
                          class="span-error-message"
                        >
                          *
                    ...
                    <div class="form-row">
                      ...
                      <div
                        :class="{
                          ...
                          'col-sm-6': form_datos_usuario.modo == 'EDITAR',
                        }"
                      >
                        <span
                          v-if="
...
export default {
  ...
  methods: {
    ...
    NuevoUsuario() {
      ...
      this.form_datos_usuario.id_cargo = 0;
      this.form_datos_usuario.id_sede = 0;
      this.form_datos_usuario.modo = "NUEVO";
    ...
    EditarUsuario(usuario) {
      ...
      this.form_datos_usuario.direccion = usuario.clinica_uno;
      this.form_datos_usuario.direccion = usuario.clinica_dos;
    ...
    CesarUsuario() {
      ...
      Swal.fire({
        ...
        preConfirm: (motivo_cese) => {
          ...
          // axios
          //   .post(route("usuarios_gestion.cesar"), data)
          ...
          //           self.$inertia.get(route("usuarios_gestion"));
          //         },
          //       });
          //     } else {
          //       Swal.fire({
          ...
          self.$inertia.post(route("usuarios_gestion.cesar"), data, {
            preserveScroll: true,
            onStart: (visit) => {
              let timerInterval;
              Swal.fire({
